...
if __name__ == "__main__":
    ...
    company_id = '781162051559776256'  # 替换为实际的公司 ID
    distribution_line_id = '883352253930082305'  # 替换为实际的配电线路 ID
...
#             {
#                 "$set": {
#                     "P": {"$multiply": [f"${p_field}", 3]},
#                     "PQ_P_A": {"$multiply": [f"${p_field}", 3]},
#                     "PQ_P_A_CALC": {"$multiply": [f"${p_field}", 3]}
#                 }
#             }
#         ]
...
#                 {
#                     "$set": {
#                         "Q": {"$multiply": [f"${q_field}", 3]},
#                         "PQ_P_R": {"$multiply": [f"${q_field}", 3]},
#                         "PQ_P_R_CALC": {"$multiply": [f"${q_field}", 3]}
#                     }
#                 }
#             ]
#             result_Q = collection.update_many(filter_query, update_Q_pipeline)
